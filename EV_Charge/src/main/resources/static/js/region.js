const regions = {
    ...
    "부산광역시": [
        "강서구", "금정구", "기장군", "남구", "동구", "동래구", "북구", "사상구", "사하구",
    ...
    "경기도": [
        ...
        "동두천시", "부천시", "북동천시", "성남시", "수원시", "시흥시", "안산시", "안성시", "안양시",
    ...
    "충청북도": [
        "괴산군", "단양군", "보은군", "영동군", "옥천군", "음성군", "제천시", "진천군", "청원구",
        "충주시"
    ],
    "충청남도": [
    ...
    "전라남도": [
        "강진군", "고흥군", "광양시", "구례군", "나주시", "담양군", "도초도", "목포시", "무안군",
    ...
    "경상남도": [
        ...
        "의령군", "진주", "창녕군", "창원시", "통영시", "하동군", "함안군", "함양군", "합천군"
    ],
    "제주도": [
        "서귀포시", "제주시"
    ]
